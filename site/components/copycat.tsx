...
const Copycat: React.FC = () => {
  ...
  const ENDPOINT: string = "https://fdgb1jgo7k.execute-api.us-east-1.amazonaws.com/prod/generate_snippet_and_keywords";
  const option: any = {
    method: "GET",
    mode: "no-cors",
  }
  ...
  const onSubmit = async() => {
    ...
    setIsLoading(true);
    await fetch(`${ENDPOINT}?prompt=${prompt}`, option)
      .then((res) => res.json())
      .then(onResult);
  };
